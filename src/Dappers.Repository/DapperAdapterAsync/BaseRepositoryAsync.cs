...
namespace Dappers.Repository
{
    ...
    internal class BaseRepositoryAsync<T>
    {
        ...
        /// <returns></returns>
        public virtual async Task<int> ExecuteAsync(string sql, object param, IDbTransaction trans = null)
        {
        ...
        /// <returns></returns>
        public virtual async Task<IEnumerable<T>> QueryAsync(string sql, object param = null, IDbTransaction trans = null)
        {
            var conn = GetConnection();
